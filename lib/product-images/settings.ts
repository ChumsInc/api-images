...
export const imagePaths:Record<string|number, string> = {
...
export const imgPath = (pathname:string|number, filename:string):string => {
 ...
 * @return {string}
 */
export const webPath = (pathname:string|number, filename:string):string => {
